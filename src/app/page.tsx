      ...
      <main className="mx-auto w-full max-w-4xl">
        ...
        <div className="mx-auto w-full max-w-2xl rounded-2xl bg-white p-8 shadow-xl ring-1 ring-zinc-900/5 dark:bg-zinc-900 dark:ring-white/10 sm:p-10">
          <div className="mb-8 text-center">
            <Image
              src="/unloved-actors-guild-logo.png"
              alt="The Unloved Actors Guild"
              width={168}
              height={168}
              priority
              className="mx-auto mb-4 h-[168px] w-[168px]"
            />
          ...
          <form className="space-y-6" onSubmit={handleGenerate}>
            ...
            <button
              ...
              className="w-full rounded-lg bg-[#1b2545] px-4 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-[#28356b] focus:outline-none focus:ring-2 focus:ring-[#1b2545]/50 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 dark:focus:ring-offset-zinc-900"
            >
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
              ...
              <button
                ...
                className="rounded-lg bg-[#1b2545] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#28356b] focus:outline-none focus:ring-2 focus:ring-[#1b2545]/50 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 dark:focus:ring-offset-zinc-950"
              >
                {isSaving
                  ? "Saving..."
                  : showSavedMsg
